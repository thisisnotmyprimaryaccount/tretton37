...
export function applyTools(ninjas: Ninja[], tools: ActiveTools): Ninja[] {
...
export function buildNameAndOfficesOptions(ninjas: Ninja[]): string {
...
export function buildNinja(ninja: Ninja): string {
    let externals = '';
    if (ninja.gitHub) {
        externals += `
...
export function renderNinjas(mount: Element, ninjas: Ninja[], tools: ActiveTools) {
